...
function triggerEffects(dep, debuggerEventExtraInfo) {
    ...
    for (const effect of Object(shared_esm_bundler["f" /* isArray */])(dep) ? dep : [...dep]) {
...
function createGetter(isReadonly = false, shallow = false) {
    return function get(target, key, receiver) {
        ...
        if (isRef(res)) {
            ...
            const shouldUnwrap = !targetIsArray || !Object(shared_esm_bundler["h" /* isIntegerKey */])(key);
...
function ownKeys(target) {
    track(target, "iterate" /* ITERATE */, Object(shared_esm_bundler["f" /* isArray */])(target) ? 'length' : ITERATE_KEY);
...
function markRaw(value) {
    Object(shared_esm_bundler["b" /* def */])(value, "__v_skip" /* SKIP */, true);
    return value;
}
...
var VueFrameworkOverrides_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
var VueFrameworkOverrides_VueFrameworkOverrides = /** @class */ (function (_super) {
    VueFrameworkOverrides_extends(VueFrameworkOverrides, _super);
...
var AgGridVue_assign = (undefined && undefined.__assign) || function () {
    AgGridVue_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return AgGridVue_assign.apply(this, arguments);
};
...
var AgGridVue_a = getAgGridProperties(), AgGridVue_props = AgGridVue_a[0], AgGridVue_watch = AgGridVue_a[1];
var AgGridVue = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
    render: function () {
        return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])('div');
    },
    props: AgGridVue_assign({ gridOptions: {
            type: Object,
    ...
    watch: AgGridVue_assign({ modelValue: {
            handler: function (currentValue, previousValue) {
